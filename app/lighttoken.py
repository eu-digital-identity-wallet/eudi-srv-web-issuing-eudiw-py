...
def create_request(country, loa):
    ...
    """
    id = str(uuid.uuid4())
    lightRequest = """<?xml version="1.0" encoding="UTF-8" standalone="yes"?><lightRequest xmlns="http://cef.eidas.eu/LightRequest">
        <citizenCountryCode>""" + country + """</citizenCountryCode>
        <id>""" + id + """</id>
    ...
    specificNodeConnectorRequestCache = client.get_cache('specificNodeConnectorRequestCache')
    ...
    bltForDigest = id + "|" + issuer + "|" + timestamp + "|" + cfgserv.eidasnode_lightToken_secret

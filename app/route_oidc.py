...
from flask import Blueprint, jsonify, Response, request, session, current_app, redirect, render_template
...
def token():
    ...
    if req_args["grant_type"] == "authorization_code":
        ...
        payload = 'grant_type=authorization_code&code=' + code + '&redirect_uri=https%3A%2F%2Fissuer.eudiw.dev%2Fpreauth-code&client_id=ID&state=vFs5DfvJqoyHj7_dZs2JbdklePg6pMLsUHHmVIfobRw&code_verifier=FnWCRIhpJtl6IYwVVYB8gZkQsmvBVLfU4HQiABPopYQ6gvIZBwMrXg'
        headers = {
